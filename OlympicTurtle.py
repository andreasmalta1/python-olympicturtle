# Create a Python program that draws the olympic logo
...
# Function to draw the Olympic Logo
def draw_shape():
    ...
    # Set the colors of the first row and second row for the Olympic Logo
